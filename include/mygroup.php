<div class="box_c">
                        <div class="box_c_heading cf">
                            <p>Mi Jefe Directo: <a href="/users/<?php echo $row_cinfoact['parent_directory']; ?>"><?php echo $row_cinfoact['parent_directory']; ?></a></p>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="content_actions" align="center">
                                        	<a href="/users/<?php echo $row_cmigrupo['username']; ?>" class="sepV_a" title="Ver Perfil : <?php echo $row_cmigrupo['username']; ?>"><img src="/img/ico/open/agent.png" alt="" /></a>
                                       		<a href="/calendars/<?php echo $row_cmigrupo['username']; ?>/" class="sepV_a" title="Ver Horarios : <?php echo $row_cmigrupo['username']; ?>"><img src="/img/ico/open/calendar.png" alt="" /></a>
                                        </td>
                                    </tr>
