			...
			<div class="row">
				<div class="three columns hide-on-phones">
					<nav id="smoothmenu_v" class="ddsmoothmenu" style="opacity: 0.8;">
						<?php include('include/menutickets.php') ?>
					</nav>
				</div>
				<div class="nine columns">
                
                <?php if (!empty($_GET['fg'])) {?>
                
				<?php if (($_GET['fg']) == 'newticket') { include('include/ticketnew.php'); }
						elseif (($_GET['fg']) == 'bandeja') { include('include/bandejatickets.php'); }
						elseif (($_GET['fg']) == 'outmsg') { include('include/bandejastickets.php'); }
						elseif (($_GET['fg']) == 'draft') { include('include/msgborradores.php'); }
						elseif (($_GET['fg']) == 'view') { include('include/viewmsg.php'); }
						
						 ?>
				
				<?php } else { ?><?php include('include/bandejatickets.php') ?><?php } ?>
