...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tickets (`create`, destination, fcreation, asunto, mgs, type) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['create'], "text"),
                       GetSQLValueString($_POST['destination'], "text"),
                       GetSQLValueString($_POST['fcreation'], "date"),
