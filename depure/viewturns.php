...
mysql_select_db($database_cae, $cae);
$query_cback = "SELECT * FROM temp_turnos WHERE id = '$_GET[id]'";
        ...
        <div class="container">
			<div class="row">
				<div class="three columns hide-on-phones">
					...
					<?php if (!empty($_GET['user'])) {include('include/menuperfils.php');} else { header('Location: index.php'); } ?>
				</div>
				<div class="nine columns">
                <?php include('include/viewturns.php'); ?>
				</div>
			</div>
		</div>
